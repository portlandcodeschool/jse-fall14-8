var MemoryGUI = (function() { // begin IIFE
    ...
    function GUI(game) { //ctor
        ...
        // ===== Listen for the showCard trigger from the lift fn =====
        $(document).on('showCard', function (event, data) {
            self.show(data.where, data.faceVal)
        });
        ...
        // ===== Listen for the hideCard trigger from the lift fn =====
        $(document).on('hideCard', function (event, data) {
            self.hideSoon([data.where, data.faceupCard]);
        });
        ...
        // ===== Listen for the removeCard trigger from the lift fn =====
        $(document).on('removeCard', function (event, data) {
            self.removeSoon([data.where, data.faceupCard]);
        });
        ...
        // ===== Listen for the gameOver trigger from the lift fn =====
